...
% ---------- 页面：A4，上下左右 2.5cm ----------
% 依赖宏包清单（缺少任一宏包将导致编译失败；TeX Live 需 texlive-latex-extra 与 texlive-fonts-extra，MiKTeX 首次编译联网自动安装）: geometry, amsmath, graphicx, float, titlesec, tocloft, booktabs, array, xcolor, listings, fancyhdr
